...
const PatientDischarge: React.FC = () => {
  ...
  const handleDischarge = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(`${selectedPatient.mrn.startsWith('C-') ? 'Consultation' : 'Patient'} ${selectedPatient.patient_name} has been successfully discharged.`);
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="ml-2 flex-shrink-0 flex">
                    <p className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                      {patient.mrn.startsWith('C-') ? 'Consultation' : 'Admission'}
                    </p>
                  </div>
                </div>
                <div className="mt-2 sm:flex sm:justify-between">
                  ...
                  <div className="mt-2 flex items-center text-sm text-gray-500 sm:mt-0">
                    ...
                    <p>
                      {patient.mrn.startsWith('C-') ? 'Created' : 'Admitted'}: {patient.admission_date} {patient.admission_time}
                    </p>
                  </div>
                </div>
                <div className="mt-2">
          ...
          <div className="bg-white shadow sm:rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <h3 className="text-lg leading-6 font-medium text-gray-900">
                Discharge {selectedPatient.mrn.startsWith('C-') ? 'Consultation' : 'Patient'}: {selectedPatient.patient_name}
              </h3>
              <form onSubmit={handleDischarge} className="mt-5 space-y-4">
                ...
                <div>
                  ...
                  >
                    ...
                    Discharge {selectedPatient.mrn.startsWith('C-') ? 'Consultation' : 'Patient'}
                  </button>
                </div>
              </form>
            </div>
